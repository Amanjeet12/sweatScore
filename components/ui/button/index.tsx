...
const buttonTextStyle = tva({
  base: 'text-typography-0 font-bold font-body web:select-none',
  parentVariants: {
    action: {
      primary:
...
const LoadingButton = React.forwardRef<React.ComponentRef<typeof Button>, LoadingButtonProps>(
  function LoadingButton(
    ...
    return (
      <Button ref={ref} disabled={disableWhileLoading ? loading || disabled : disabled} {...props}>
        {loading && spinnerPlacement === 'start' && <ButtonSpinner />}
        ...
        {loading && spinnerPlacement === 'end' && <ButtonSpinner />}
      </Button>
    );
  }
);
...
export { Button, ButtonText, ButtonSpinner, ButtonIcon, ButtonGroup, LoadingButton };
