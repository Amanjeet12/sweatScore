...
import { CheckCircle, Clock, Check } from 'phosphor-react-native';
    ...
    return (
      <View
        ...
        <ImageBackground
          ...
          <LinearGradient
            colors={['rgba(0,0,0,0.18)', 'rgba(0,0,0,0.08)', 'rgba(0,0,0,0.72)']}
            locations={[0, 0.45, 1]}
          ...
          <TouchableOpacity
            ...
            <View className="flex-row items-center justify-center">
              ...
              <Text
                ...
                {isCompleted ? 'Check-In Completed' : 'Check In Now'}
              </Text>
            </View>
          </TouchableOpacity>
        </LinearGradient>
